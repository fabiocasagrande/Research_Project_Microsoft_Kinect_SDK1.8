...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public class AvateeringXNA : Microsoft.Xna.Framework.Game
    {
       ...
       // private Texture2D header;
        ...
        private AvatarAnimator animator1;
        
        /// <summary>
        /// Viewing Camera arc.
        /// </summary>
        private float cameraArc = 18;
        ...
        private bool drawAvatarOnlyWhenPlayerDetected1;
        /// <summary>
        /// Flag for first detection of skeleton.
        /// </summary>
        private bool skeletonDetected;
        private bool skeletonDetected1;
        /// <summary>
       ...
       private string av1 = "model/";
       private string av2 = "model/";
       private string sc = "";
            ...
            
        {
          ...
          //SplashScreen splash = new SplashScreen("Images/title.png");
         // splash.Show(true); 
         


            this.Window.Title = "Educational Project";
           ...
           // this.graphics.IsFullScreen = true;
            ...
            //Create the avatar2 animator1
            
            this.animator1 = new AvatarAnimator(this, this.RetargetMatrixHierarchyToAvatarMesh, AvateeringXNA.SkeletonTranslationScaleFactor);
            this.Components.Add(this.animator1);


            // Drawing options
            this.setSeatedPostureInSeatedMode = true;
            this.drawAvatarOnlyWhenPlayerDetected = true;
            this.drawAvatarOnlyWhenPlayerDetected1 = true;
            this.skeletonDetected = false;
            this.skeletonDetected1 = false;
    ...
    //    private static Skeleton[] SkeletonData1 { get; set; }

        private void Initialize_Avatar_Scenario()
        {
            ...
            //Console.WriteLine("jajshcjahsjdhjashdjhasjdh"+ av1+" "+av2+" "+sc);



            if (av1.Equals("model/default") || av1.Equals("") || av1.Equals(" "))
            {
                av1 = "model/kid1";
            }
            if (av2.Equals("model/default") || av2.Equals("") || av2.Equals(" "))
            {
                av2 = "model/kid1";
            }
            if (sc.Equals("sandbox/default") || sc.Equals("") || sc.Equals(" "))
            {
                sc = "sandbox/cafeteria";
            }

            //Console.WriteLine("Avatar1= " + av1 + " Avatar2= " + av2 + " Scenario= " + sc + " ");
        ...
        protected override void LoadContent()
        {
          ...
          // SandboxModel = this.Content.Load<Model>("sandbox/sad");

            //Initialize av1,av2,scenatio paths
            this.Initialize_Avatar_Scenario();
            ...
            if (sc.Contains("library"))
            {
                
                sc="sandbox/library";
                this.cameraArc = 16;
            }
            else if (sc.Contains("cafeteria"))
            {
               sc="sandbox/cafeteria";
               this.cameraArc = 18;

            }
            else if (sc.Contains("schoolHall"))
            {
                sc="sandbox/schoolHall";
                this.cameraArc = 18;
            }
            else if (sc.Contains("classroom"))
            {
                sc="sandbox/classroom";
                this.cameraArc = 15;
            }

            else if (sc.Contains("default"))
            {
                sc="sandbox/classroom";
                this.cameraArc = 15;
            }
            ...
            background = Content.Load<Texture2D>(sc);
           ...
           // this.header = Content.Load<Texture2D>("Header");
            this.cameraArc += 2 * CameraArcIncrement;
            ...
            // Load the models.
            this.currentModel = Content.Load<Model>(av1);
            this.currentModel1 = Content.Load<Model>(av2);

          
            


            if (null == this.currentModel || null == this.currentModel1  )
            {
            ...
            // Add the model1 to the avatar animator
            this.animator1.Avatar = this.currentModel1;
            this.animator1.AvatarHipCenterHeight = this.avatarHipCenterDrawHeight;
        ...
        protected void BuildJointHierarchy()
        {
            ...
            this.nuiJointToAvatarBoneIndex.Add(JointType.Spine, 4);      //spine2
            this.nuiJointToAvatarBoneIndex.Add(JointType.ShoulderCenter, 5); //gomito sinistro
            this.nuiJointToAvatarBoneIndex.Add(JointType.Head, 6);
            this.nuiJointToAvatarBoneIndex.Add(JointType.ElbowLeft, 9); //upper arm
            this.nuiJointToAvatarBoneIndex.Add(JointType.WristLeft, 10);//lower arm
            this.nuiJointToAvatarBoneIndex.Add(JointType.HandLeft, 11);//hand

            this.nuiJointToAvatarBoneIndex.Add(JointType.ShoulderRight, 14);
            this.nuiJointToAvatarBoneIndex.Add(JointType.ElbowRight, 15);
            this.nuiJointToAvatarBoneIndex.Add(JointType.WristRight, 16);
            this.nuiJointToAvatarBoneIndex.Add(JointType.HandRight, 17);

            this.nuiJointToAvatarBoneIndex.Add(JointType.KneeLeft, 20);
            this.nuiJointToAvatarBoneIndex.Add(JointType.AnkleLeft, 21);
            this.nuiJointToAvatarBoneIndex.Add(JointType.FootLeft, 22);
            this.nuiJointToAvatarBoneIndex.Add(JointType.KneeRight, 27);
            this.nuiJointToAvatarBoneIndex.Add(JointType.AnkleRight, 28);
            this.nuiJointToAvatarBoneIndex.Add(JointType.FootRight, 29);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            using (var skeletonFrame = this.Chooser.Sensor.SkeletonStream.OpenNextFrame(0))
            {
                ...
                if (null != skeletonFrame)
                {
                    ...
                    Skeleton rawSkeleton1 =

                        (from i in SkeletonData
                         where i != rawSkeleton && i.TrackingState == SkeletonTrackingState.Tracked
                         select i).LastOrDefault();


                    if (null != this.animator1)
                    {
                        if (null != rawSkeleton1)
                        {
                            this.animator1.CopySkeleton(rawSkeleton1);
                            this.animator1.FloorClipPlane = skeletonFrame.FloorClipPlane;

                            // Reset the filters if the skeleton was not seen before now
                            if (this.skeletonDetected1 == false)
                            {
                                this.animator1.Reset();
                            }

                            this.skeletonDetected1 = true;
                            this.animator1.SkeletonVisible = true;
                        }
                        else
                        {
                            this.skeletonDetected1 = false;
                            this.animator1.SkeletonVisible = false;
                        }
                    }
            ...
            if (newFrame)
            {
                ...
                if (null != this.animator1)
                {
                    this.animator1.SkeletonDrawn = false;
                }
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            **/
            ...
            // Draw the actual avatar1
            if (null != this.animator1 && (!this.drawAvatarOnlyWhenPlayerDetected1 || (this.drawAvatarOnlyWhenPlayerDetected1 && this.skeletonDetected1)))
            {
                this.animator1.Draw(gameTime, Matrix.Identity, this.view, this.projection);
            }
        ...
        private void UpdateCamera(GameTime gameTime)
        {
                ...
                this.currentKeyboard.IsKeyDown(Keys.W))
            {
                ...
                Console.WriteLine(this.cameraArc);
        ...
        private void SetJointTransformation(BoneOrientation bone, Skeleton skeleton, Matrix bindRoot, ref Matrix[] boneTransforms)
        {
            ...
            if (bone.StartJoint == JointType.HipCenter && bone.EndJoint == JointType.HipCenter)
            {
                ...
                /**
                   ...
                   Matrix Yaxisflip = Matrix.CreateRotationY(MathHelper.ToRadians(45));
                  invBindRoot *= Yaxisflip;
        ...
        private void RetargetMatrixHierarchyToAvatarMesh1(Skeleton skeleton, Matrix bindRoot, Matrix[] boneTransforms)
        {
            if (null == skeleton)
            {
                return;
            ...
            foreach (BoneOrientation bone in skeleton.BoneOrientations)
            {
                ...
                this.SetJointTransformation1(bone, skeleton, bindRoot, ref boneTransforms);
            }
        ...
        private void SetJointTransformation1(BoneOrientation bone, Skeleton skeleton, Matrix bindRoot, ref Matrix[] boneTransforms)
        {
